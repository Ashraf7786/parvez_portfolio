...
const FloatingActions: React.FC = () => {
  return (
    <div className="hidden md:flex fixed right-6 bottom-8 z-[60] flex-col gap-4">
      {/* WhatsApp Action */}
      <a 
        href="https://wa.me/918502840525" 
        target="_blank" 
        rel="noopener noreferrer"
        className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform group relative"
      ...
      >
        ...
        <div className="absolute right-16 bg-white text-black text-[9px] font-black uppercase px-3 py-1 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none shadow-xl border border-neutral-200">
          WhatsApp Us
        </div>
      </a>
      ...
      <a 
        ...
        className="w-14 h-14 bg-primary rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(184,155,122,0.4)] hover:scale-110 transition-transform group relative border-2 border-white/20"
        title="Call Now"
      >
        <span className="material-symbols-outlined text-black text-3xl">call</span>
        <div className="absolute right-16 bg-white text-black text-[9px] font-black uppercase px-3 py-1 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none shadow-xl border border-neutral-200">
          Call Atelier
        </div>
      </a>
